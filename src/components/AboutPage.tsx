...
const AboutPage: React.FC<AboutPageProps> = ({
  ...
  // Source indicator colors for developer section
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                For Developers: Understanding the Spark
              </h2>

              <p style={{ marginBottom: '24px' }}>
                If you look closely, you might notice tiny colored dots scattered throughout the interface. 
                These subtle indicators are designed for developers and curious minds to understand the 
                source of the content being generated.
              </p>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      height: '12px',
                      borderRadius: '50%',
                      background: getOpenAISuccessColor()
                    }} />
                    <span style={{
                      fontFamily: "'Courier Prime', monospace",
                      fontSize: '0.9rem',
                  ...
                  <div style={{
                    ...
                    Green dots indicate content successfully generated by OpenAI's API - 
                    whispers transformed from headlines and poems crafted from your inputs.
                  </div>
                </div>
                ...
                <div style={{
                  padding: '16px',
                  borderRadius: '12px',
                  background: isDarkMode ? 'rgba(251, 146, 60, 0.1)' : 'rgba(251, 146, 60, 0.05)',
                  ...
                  <div style={{
                    ...
                    Orange dots indicate content generated by our fallback systems when 
                    OpenAI's API is unavailable, ensuring the experience continues seamlessly.
                  </div>
                </div>
              </div>
